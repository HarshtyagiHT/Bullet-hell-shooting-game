...
class GameScreen implements Screen {
    ...
    public TextureRegion playerTextureRegion, playerShieldTextureRegion,
            enemyTextureRegion, enemyShieldTextureRegion,
    ...
    // world parameters
    public final float WORLD_WIDTH = 72;
    public final float WORLD_HEIGHT = 128;
    public final float TOUCH_MOVEMENT_THRESHOLD = 5f;
    ...
    GameScreen() {
        ...
        textureAtlas = new TextureAtlas("games.atlas");
        ...
        playerTextureRegion = textureAtlas.findRegion("playerShip2_blue");
        enemyTextureRegion = textureAtlas.findRegion("enemyRed3");
        ...
        // set up game objects
        playerShip = new Player.CharacterBuilder().setX(WORLD_WIDTH / 2).setY(WORLD_WIDTH / 2).setWidth(10)
                .setHeight(10)
                .setMovementSpeed(48).setShield(3).setLaserWidth(0.4f).setLaserHeight(4).setLaserMovementSpeed(45)
                .setTimeBetweenShots(0.5f).setLaserTextureRegion(playerLaserTextureRegion)
                .setShieldTextureRegion(playerShieldTextureRegion).setShipTextureRegion(playerTextureRegion)
                .build();
    ...
    public void render(float deltaTime) {
        ...
        ListIterator<Enemy> enemyShipListIterator = enemies.listIterator();
    ...
    private void spawnEnemyShips(float deltaTime) {
        ...
        if (enemySpawnTimer > timeBetweenEnemySpawns) {
            Enemy enemy = new Enemy.CharacterBuilder().setX(PowerPuffGirls.random.nextFloat() * (WORLD_WIDTH - 10) + 5)
                    .setY(WORLD_HEIGHT - 5).setWidth(10).setHeight(10).setMovementSpeed(48).setShield(1)
                    .setLaserWidth(0.3f).setLaserHeight(5).setLaserMovementSpeed(50).setTimeBetweenShots(0.8f)
                    .setLaserTextureRegion(enemyLaserTextureRegion).setShieldTextureRegion(enemyShieldTextureRegion)
                    .setShipTextureRegion(enemyTextureRegion).build();
            enemies.add(enemy);
    ...
    private void moveEnemy(Enemy enemyShip, float deltaTime) {
        // strategy: determine the max distance the ship can move
